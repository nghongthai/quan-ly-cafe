...
class PaymentStaffScreen extends StatefulWidget {
  ...
  @override
  State<PaymentStaffScreen> createState() => _PaymentScreenState();
}

class _PaymentScreenState extends State<PaymentStaffScreen> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          if (isSelected)
            const Icon(Icons.check_circle, color: Color(0xFF3B67D9), size: 20),
        ],
      ),
    );
  }

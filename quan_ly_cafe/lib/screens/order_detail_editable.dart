...
class OrderDetailEditableScreen extends StatefulWidget {
  ...
  @override
  State<OrderDetailEditableScreen> createState() =>
      _OrderDetailEditableScreenState();
}
...
class _OrderDetailEditableScreenState extends State<OrderDetailEditableScreen> {
  ...
  void initState() {
    ...
    final rawItems =
        widget.order['order_details'] ?? widget.order['orderDetails'];
    if (rawItems != null) {
      setState(() {
  ...
  void checkout() {
    ...
    Map<String, dynamic> orderDataForPayment = Map<String, dynamic>.from(
      widget.order,
    );
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (imageName.isNotEmpty) {
                      assetPath = imageName.contains("assets/")
                          ? imageName

            ...
            children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3),
                        Text(
                          'Bắt đầu phiên làm việc hôm nay',
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  prefixIcon: const Icon(Icons.payments_outlined, color: Color(0xFF1A237E)),
                  suffixText: 'đ',
                  filled: true,
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(14),
                    borderSide: const BorderSide(color: Color(0xFF1A237E), width: 1.4),
                  ),
                ),
              ),
              const SizedBox(height: 18),
              ...
              const SizedBox(height: 10),
              _openingChecklistRow(Icons.account_balance_wallet_outlined, 'Kiểm tra quỹ tiền mặt đầu ca'),
              _openingChecklistRow(Icons.table_restaurant_outlined, 'Kiểm tra bàn đang dùng'),
              _openingChecklistRow(Icons.receipt_long_outlined, 'Kiểm tra đơn còn tồn'),
